...
with st.expander("## :green[Web-Pages :globe_with_meridians:]"):
...
with st.expander(":green[Additional Web Pages and Python libraries :snake:]"):
...
with st.expander(":green[Books :green_book:]"):
